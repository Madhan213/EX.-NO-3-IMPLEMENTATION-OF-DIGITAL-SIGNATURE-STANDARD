...
int main() {
    ...
    if (M == M1) {
        printf("As M = M1, accept the message sent by Madhan.\n");
    } else {
...
![Screenshot 2024-10-16 215047](https://github.com/user-attachments/assets/cc40eff5-3659-49b1-a391-6b6e4953313c)
